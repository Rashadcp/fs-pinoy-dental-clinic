/**
 * Inline SVG Icons — replaces external Icons8 network requests.
 * All icons render instantly with zero network dependency.
 */
...
export const MarkerIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="-3 -3 30 30" fill="currentColor">
...
export const PulseIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M16 11H2V9h14l-4-4 1.41-1.41L20 11l-6.59 6.59L12 16l4-4zm6-8v18h-2V3h2z" />
  </svg>
);
...
export const MedalIcon = ({ className }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zM8.465 3L7 5.5 8.5 9H6l-2 3h16l-2-3h-2.5L17 5.5 15.535 3H8.465z" />
  </svg>
);
